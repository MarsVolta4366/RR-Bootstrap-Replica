...
export default function Header() {
    return (
        <Card style={{ width: '100%', backgroundImage: "url(../../headerBackground.png)", height: "500px", backgroundRepeat: "no-repeat", backgroundPosition: "right", backgroundColor: "#DFEED6", backgroundSize: "450px 500px" }}>
            <Card.Body style={{ textAlign: "left", width: "700px", marginLeft: "150px", marginTop: "100px" }}>
